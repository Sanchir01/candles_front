...
export type RegistrationsMutation = { __typename?: 'Mutation', auth: { __typename?: 'AuthMutations', registrations: { __typename: 'InternalErrorProblem', message: string } | { __typename: 'RegistrationsOk', id: any, email: string, role: Role, verify_code: string } | { __typename: 'VersionMismatchProblem', message: string } } };
...
export type AllCandlesQuery = { __typename?: 'Query', candles?: { __typename?: 'CandlesQuery', allCandles: { __typename: 'AllCandlesOk', candles: Array<{ __typename?: 'Candles', id: any, title: string, images: Array<string>, price: number, slug: string }> } | { __typename: 'InternalErrorProblem', message: string } | { __typename: 'VersionMismatchProblem', message: string } } | null };
...
export type CandleByIdQuery = { __typename?: 'Query', candles?: { __typename?: 'CandlesQuery', candleById: { __typename: 'CandlesByIdOk', candle: { __typename?: 'Candles', id: any, images: Array<string> } } | { __typename: 'InternalErrorProblem', message: string } | { __typename: 'VersionMismatchProblem', message: string } } | null };
...
export type AllOrdersQuery = { __typename?: 'Query', orders: { __typename?: 'OrderQuery', allOrders: { __typename: 'AllOrdersOk', orders: Array<{ __typename?: 'Orders', id: any }> } | { __typename: 'InternalErrorProblem', message: string } | { __typename: 'UnauthorizedProblem', message: string } } };
