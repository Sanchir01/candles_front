...
export type Scalars = {
   ...
   PageNumber: { input: number; output: number }
   PageSize: { input: number; output: number }
...
export type CreateColorMutation = {
   ...
   color: {
      __typename?: 'ColorMutation'
      createColor:
         | { __typename: 'ColorCreateOk'; id: string }
         | { __typename: 'InternalErrorProblem'; message: string }
...
export type AllOrdersQuery = {
   ...
   orders: {
      ...
      allOrders:
         | {
              __typename: 'AllOrdersOk'
              orders: Array<{ __typename?: 'Orders'; id: string }>
           }
         | { __typename: 'InternalErrorProblem'; message: string }
         | { __typename: 'UnauthorizedProblem'; message: string }
   }
...
export type UserIdQuery = {
   ...
   user?: {
      ...
      profile:
         ...
         | {
              __typename: 'UserProfileOk'
              profile: { __typename?: 'User'; id: string; role: Role }
           }
         | { __typename: 'VersionMismatchProblem'; message: string }
   } | null
}
