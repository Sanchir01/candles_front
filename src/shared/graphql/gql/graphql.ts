...
export type CandlesDeleteOk = {
	__typename?: 'CandlesDeleteOk'
...
export type CandlesMutation = {
	...
	deleteCandle: DeleteCandlesResult
}
...
export type CandlesMutationDeleteCandleArgs = {
	input?: InputMaybe<DeleteCandleInput>
}
...
export type DeleteCandlesResult =
	| CandlesDeleteOk
	| InternalErrorProblem
	| UnauthorizedProblem
	| VersionMismatchProblem
...
export type AllCandlesTotalCountQuery = {
	__typename?: 'Query'
	candles?: {
		__typename?: 'CandlesQuery'
		allCandles:
...
export type DeleteCandleByIdMutationVariables = Exact<{
	input?: InputMaybe<DeleteCategoryInput>
}>

export type DeleteCandleByIdMutation = {
	__typename?: 'Mutation'
	category: {
		__typename?: 'CategoryMutation'
		delete?:
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'InternalErrorProblem' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'RegistrationsOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'NewTokensOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'DeleteTokensOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'AllCandlesOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
...
export const AllCandlesTotalCountDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
	...
	AllCandlesTotalCountQuery,
	AllCandlesTotalCountQueryVariables
>
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'CandlesByIdOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
...
export const DeleteCandleByIdDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'DeleteCandleById' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: {
										...
										selections: [
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'DeleteCategoryOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
	...
	DeleteCandleByIdMutation,
	DeleteCandleByIdMutationVariables
>
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'CategoryGetAllOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'CategoryByIdOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'CategoryCreateOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'UnauthorizedProblem' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'AllColorOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'ColorByIdOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'ColorCreateOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'DeleteColorOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'AllOrdersOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'AllUserOrdersOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'CreateOrderOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
									...
									selectionSet: {
										...
										selections: [
											...
											},
											{
												...
												typeCondition: {
													kind: 'NamedType',
													name: { kind: 'Name', value: 'UserProfileOk' }
												},
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
